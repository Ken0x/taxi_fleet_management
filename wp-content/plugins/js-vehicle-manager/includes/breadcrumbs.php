                ...
                switch ($module) {
                    case 'user':
                        ...
                        switch ($layout) {
                            ...
                            break;
                            case 'sellerlist':
                                $array[] = array('link' => jsvehiclemanager::makeUrl(array('jsvmme'=>'user', 'jsvmlt'=>'sellerlist')), 'text' => __('Driver List', 'js-vehicle-manager'));
                            break;
                            case 'sellersbycity':
                                $array[] = array('link' => jsvehiclemanager::makeUrl(array('jsvmme'=>'user', 'jsvmlt'=>'sellersbycity')), 'text' => __('Drivers By City', 'js-vehicle-manager'));
                            break;
                            case 'userregister':
                            ...
                            case 'viewsellerinfo':
                                $array[] = array('link' => jsvehiclemanager::makeUrl(array('jsvmme'=>'user', 'jsvmlt'=>'sellerlist')), 'text' => __('Driver List', 'js-vehicle-manager'));
                                $array[] = array('link' => jsvehiclemanager::makeUrl(array('jsvmme'=>'user', 'jsvmlt'=>'viewsellerinfo')), 'text' => __('Driver Info', 'js-vehicle-manager'));
                            break;
                        }
                    break;
                    case 'vehicle':
