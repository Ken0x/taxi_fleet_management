		...
		?>
			<p>
				...
				<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'vehiclemanagerpages' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'vehiclemanagerpages' ) ); ?>" >
					...
					<option value="11" <?php echo ( $vehiclemanagerpages == 11 ) ? 'selected="selected"' : false; ?>><?php echo esc_html__('Drivers List','js-vehicle-manager'); ?></option>
					<option value="12" <?php echo ( $vehiclemanagerpages == 12 ) ? 'selected="selected"' : false; ?>><?php echo esc_html__('Drivers By City','js-vehicle-manager'); ?></option>
