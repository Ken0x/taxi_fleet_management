...
<div id="jsvehiclemanageradmin-menu-links">
    ...
    <div class="jsvm_js-divlink">
        ...
        <a href="#" class="jsvm_js-parent <?php if($c == 'jsvm_cylinders') echo 'jsvm_lastshown'; ?>"><span class="jsvm_text"><?php echo __('Tires' , 'js-vehicle-manager'); ?><img class="jsvm_arrow" src="<?php echo jsvehiclemanager::$_pluginpath.'includes/images/left-icons/arrow1.png'; ?>"/></span></a>
        <div class="jsvm_js-innerlink">
            <a class="jsvm_js-child" href="admin.php?page=jsvm_cylinders"><span class="jsvm_text"><?php echo __('Tires' , 'js-vehicle-manager'); ?></span></a>
    ...
    <div class="jsvm_js-divlink">
        ...
        <div class="jsvm_js-innerlink">
            ...
            <a class="jsvm_js-child" href="admin.php?page=jsvm_emailtemplate&for=nw-sl"><span class="jsvm_text"><?php echo __('Register New Driver','js-vehicle-manager'); ?></span></a>
            ...
            <a class="jsvm_js-child" href="admin.php?page=jsvm_emailtemplate&for=mg-t-sr"><span class="jsvm_text"><?php echo __('Message To Driver','js-vehicle-manager'); ?></span></a>
         </div>
    </div>
    <div class="jsvm_js-divlink">
