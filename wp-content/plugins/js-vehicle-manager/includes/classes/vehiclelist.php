		...
		function printtemplatevehicle(&$vehicles,$isPluginCall=false) {
            ...
            if ($_SESSION['jsvm_listing_style'] == 1) {
                ...
                if(JSVEHICLEMANAGERincluder::getJSModel('configuration')->getConfigurationByConfigName('vehiclelist_sellerimage') == 1){
                    if($row->sellerphoto != ''){
                                                    $simg = '<a href ="'.jsvehiclemanager::makeUrl(array('jsvehiclemanagerpageid'=>jsvehiclemanager::$_data['filter']['jsvehiclemanagerpageid'], 'jsvmme'=>'user', 'jsvmlt'=>'viewsellerinfo', 'jsvehiclemanagerid'=>$row->sellerid)).'" title="'.esc_attr('Driver').'" >
