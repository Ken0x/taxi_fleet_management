...
function jsvehiclemanager_tinymce_button_lang() {
    ...
    var jslang = {
        ...
        'sellersbycity' : '<?php echo __("Drivers by City", "js-vehicle-manager"); ?>',
        ...
        'sellerlist' : '<?php echo __("Driver List", "js-vehicle-manager"); ?>',
        'sellerdetail' : '<?php echo __("Driver Detail", "js-vehicle-manager"); ?>',
...
function js_vehicle_manager_vcSetAsTheme() {
    if(jsvehiclemanager::$_car_manager_theme == 0){
        ...
        vc_map( array(
              "name" => __( "Driver List", "js-vehicle-manager" ),
        ...
        vc_map( array(
              "name" => __( "Drivers By Cities", "js-vehicle-manager" ),
