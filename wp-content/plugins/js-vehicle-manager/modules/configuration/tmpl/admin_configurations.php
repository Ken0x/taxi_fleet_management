                ...
                <div class="jsvm_tabInner">
                   ...
                   <div id="jsvm_memberlinks">
                        ...
                        <div class="js-vehicle-manager-configuration-table">
                            ...
                            <div class="jsvm_right">
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Driver By City', 'js-vehicle-manager'); ?></div>
                   ...
                   <div id="jsvm_visitorlinks">
                    ...
                    <!--Visitor Links End-->
                        ...
                        <?php } ?>
                        <h3 class="js-vehicle-manager-configuration-heading-main"><?php echo __('Driver By City', 'js-vehicle-manager'); ?></h3>
                         <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                              <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
