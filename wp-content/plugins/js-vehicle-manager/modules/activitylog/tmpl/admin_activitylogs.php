            ...
            <div id="jsvm_popup_main" style="display:none;">
                ...
                <div id="jsvm_checkbox-popup-wrapper">
                    <form id="jsvm_filter_form" method="post" action="?page=jsvm_activitylog&jsvmlt=activitylogs">
                        ...
                        <div class="jsvm_checkbox-filter"><?php echo JSVEHICLEMANAGERformfield::checkbox('filter[cylinders]', array('1' => __('Tires', 'js-vehicle-manager')), isset(jsvehiclemanager::$_data['filter']['cylinders']) ? jsvehiclemanager::$_data['filter']['cylinders'] : 0, array('class' => 'checkbox')); ?></div>
