            ...
            <form  method="post" name="adminForm" id="jsvm_adminForm" class="jsvm_form-validate js-form-horizontal" enctype="multipart/form-data" action="<?php echo admin_url("admin.php?page=jsvm_vehicle&action=jsvmtask&task=savevehicle"); ?>">
                <div class="jsvehiclemanager-form-field-wrapper">
                    ...
                    <div class="jsvm_js-form-wrapper">
                        <label id="jsvm_sellerid" for="sellerid" class="jsvehiclemanager-title"><?php echo __('Select driver','js-vehicle-manager')." :"; ?></label>
                        ...
                        <a href="#" id="jsvm_userpopup" class="jsvm_cm-userpopup vehicle-form">
                            <?php echo __('Select','js-vehicle-manager') .' '. __('Driver', 'js-vehicle-manager'); ?>
                        </a>
                        <img class="jsvehiclem-img" src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/info-icon.png" />
                        <span class="jsvehiclem-desc"><?php echo __('Your profile will be use if you do not select driver.' , 'js-vehicle-manager'); ?></span>
                    </div>
                    <?php
                    $rowcount = 0;
                ...
                <input type="hidden" id="jsvm_user-popup-title-text" name="user-popup-title-text" value="<?php echo __('Select','js-vehicle-manager') .' '. __('Driver', 'js-vehicle-manager'); ?>" />
