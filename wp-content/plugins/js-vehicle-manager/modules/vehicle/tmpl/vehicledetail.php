		 	   ...
		 	   <div id="jsvehiclemanager-flex-autoz-wrapper">
		 	   		<div id="jsvehiclemanager-detail-flex-autoz">
		 	   			<div id="jsvehiclemanager-flex-autoz-image">
		 	   				<a href="<?php echo jsvehiclemanager::makeUrl(array('jsvmme'=>'user','jsvmlt'=>'viewsellerinfo','jsvehiclemanagerid'=>$vehicle->uid,'jsvehiclemanagerpageid'=>jsvehiclemanager::getPageid()));?>">
		 	   					<img alt="<?php echo esc_attr(__('Driver Profile Icon','js-vehicle-manager')); ?>" title="<?php echo esc_attr(__('Driver Profile','js-vehicle-manager')); ?>" src="<?php echo esc_attr($vehicle->sellerphoto != '' ? $vehicle->sellerphoto : jsvehiclemanager::$_pluginpath.'includes/images/default-images/profile-image.png'); ?>"/>
		 	   				</a>
			 	   				...
			 	   				<div id="jsvehiclemanager-flex-autoz-dealer-information">
			 	   					<a href="<?php echo jsvehiclemanager::makeUrl(array('jsvmme'=>'user','jsvmlt'=>'viewsellerinfo','jsvehiclemanagerid'=>$vehicle->uid,'jsvehiclemanagerpageid'=>jsvehiclemanager::getPageid()));?>">
				 	   					<span id="jsvehiclemanager-flex-autoz-dealer-information-text">
				 	   						<?php echo __('Driver Information','js-vehicle-manager'); ?>
				 	   					</span>
			 	   					</a>
			 	   				</div>
		 	    ...
		 	    <div id="tabs" class="tabs jsvehiclemanager-vehicle-detail-tabs">
		 	   	    <ul>
		 	   	        ...
		 	   	        <li><a href="#jsvehiclemanager-sellerinformation" onclick="reDrawMap();"><?php echo __('Driver Information', 'js-vehicle-manager'); ?></a></li>
		 	   	        <?php } ?>
		 	   	    </ul>
		 	   	   	<div id="tabInner">
					...
					<?php endif;
						foreach (jsvehiclemanager::$_data[4]['main'] as $field) {
							switch ($field->field) {
		 	   	   		...
		 	   	   		<div class="jsvehiclemanager-feature-detail-list">
		 	   	   		  <div class="jsvehiclemanager-feature-detail-sub-heading">
			 	   			 <span class="jsvehiclemanager-sub-heading-text"><?php echo __('Driver Information','js-vehicle-manager'); ?></span>
			 	   		  </div><!--end of feature-detail-sub-heading -->
			 	   		</div><!--end of feature-detail-list -->
			 	   		...
			 	   		<div class="jsvehiclemanager-dealer-info-name-wrapper">
			 	   			<div class="jsvehiclemanager-dealer-info-img">
			 	   				<a href="#">
	 	    						<img alt="<?php echo esc_attr(__('Driver Profile Icon','js-vehicle-manager')); ?>" title="<?php echo esc_attr(__('Driver Profile','js-vehicle-manager')); ?>" src="<?php echo esc_attr($vehicle->sellerphoto != '' ? $vehicle->sellerphoto : jsvehiclemanager::$_pluginpath.'includes/images/Users.png'); ?>"/>
	 	    					</a>
			 	   			</div>
