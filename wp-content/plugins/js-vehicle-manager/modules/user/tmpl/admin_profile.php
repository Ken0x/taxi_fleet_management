...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        if (!empty(jsvehiclemanager::$_data['user'])) {
                ...
                <div id="jsvehiclemanager-seller-listing-top-wrap">
                    ...
                    <div id="jsvehiclemanager-seller-listing-data-wrap">
                        <div class="jsvehiclemanager-seller-listing-left">
                            ...
                            <span class="jsvehiclemanager-seller-listing-data">
                                <span class="jsvehiclemanager-seller-listing-data-title"><?php echo __('Phone','js-vehicle-manager'); ?>:</span>
                                <span class="jsvehiclemanager-seller-listing-data-value"><?php echo $row->phone; ?></span>
                            </span>
                            <?php
            ...
            <a id="jsvehiclemanager-profileview-button" href="<?php echo admin_url("admin.php?page=jsvm_vehicle&jsvmlt=vehicles&uid=".$row->id); ?>"><?php echo __('Show Driver Vehicles' , 'js-vehicle-manager'); ?></a>
            <?php
        } else {
