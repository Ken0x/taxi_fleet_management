...
<div class="jsvehiclemanager_cm-seller-wrap">
    <div class="row jsvehiclemanager_cm-margin jsvehiclemanager_cm-seller-det">
        <div class="jsvehiclemanager_cm-seller-det-left">
            <img class="img-reponsive jsvehiclemanager_cm-seller-img" src="<?php echo esc_attr($seller->photo != '' ? $seller->photo : jsvehiclemanager::$_pluginpath."includes/images/default-images/profile-image.png");?>" title="<?php echo esc_attr(__('Driver', 'js-vehicle-manager')); ?>" alt="<?php echo esc_attr(__('Driver', 'js-vehicle-manager')); ?>" />
        </div>
    ...
    <div class="row jsvehiclemanager_cm-margin jsvehiclemanager_cm-show-seller-btn-wrap">
        <a href="<?php echo esc_url(jsvehiclemanager::makeUrl(array('jsvmme'=>'vehicle', 'jsvmlt'=>'vehicles', 'sellerid'=>$seller->id))); ?>" class="btn btn-primary text-center btn-block jsvehiclemanager_cm-show-seller-btn"><?php echo esc_html__('Show Driver Vehicles','js-vehicle-manager'); ?></a>
    </div>
</div>
</div>
