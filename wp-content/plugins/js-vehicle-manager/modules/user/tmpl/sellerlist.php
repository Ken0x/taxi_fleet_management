...
<div id="jsvehiclemanager-wrapper">
        <div class="control-pannel-header">
            <span class="heading">
                <?php echo __('Driver List', 'js-vehicle-manager'); ?>
            </span>            
        </div>
    ...
    <div class="jsvehiclemanager_cm-seller-wrap">
        <div class="row jsvehiclemanager_cm-margin jsvehiclemanager_cm-seller-det">
            <div class="jsvehiclemanager_cm-seller-det-left">
                <img class="img-reponsive jsvehiclemanager_cm-seller-img" src="<?php echo esc_attr($data->photo != '' ? $data->photo : jsvehiclemanager::$_pluginpath.'includes/images/default-images/profile-image.png');?>" title="<?php echo esc_attr(__('Driver', 'js-vehicle-manager')); ?>" alt="<?php echo esc_attr(__('Driver', 'js-vehicle-manager')); ?>"/>
            </div>
            <div class="row jsvehiclemanager_cm-margin jsvehiclemanager_cm-seller-det-right">
                <div class="row jsvehiclemanager_cm-margin jsvehiclemanager_cm-seller-info-top">
                    ...
                    <span class="jsvehiclemanager_cm-seller-info-right">
                        <a title="<?php echo esc_attr(__('driver info','js-vehicle-manager')); ?>" href="<?php echo esc_url(jsvehiclemanager::makeUrl(array('jsvmme'=>'user', 'jsvmlt'=>'viewsellerinfo', 'jsvehiclemanagerid'=>$data->id))); ?>" class="jsvehiclemanager_cm-seller-info-btn btn-lg"><?php echo esc_html__('View Driver Info','js-vehicle-manager'); ?></a> 
                    </span>
                </div>
